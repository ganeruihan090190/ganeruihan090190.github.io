...
<body>
    ...
    <header class="header">
        <div class="container">
            ...
            <nav class="navbar">
                <ul>
                    <li class="pad"><a href="home.php">Home</a></li>
                    ...
                    <li class="right"><a href="Login.php"><button class="tombol-log">Login</button></a></li>
                    <li><a href="Register.php"><button class="tombol-reg">Register</button></a></li>
                </ul>
            </nav>
        </div>
    </header>
